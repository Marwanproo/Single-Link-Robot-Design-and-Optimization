...
int main()
{
    ...
    cout << "Do you want to enter motors (Enter 1 ) or just use the database (Enter 2) " <<endl;
    int in_motors = checkValidation(1,2);
    if(in_motors == 1)setMotorsDatabase(motors);
    cout << "Do you want to enter gearboxes (Enter 1 ) or just use the database (Enter 2) " <<endl;
